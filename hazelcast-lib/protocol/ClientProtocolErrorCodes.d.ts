export declare class ClientProtocolErrorCodes {
    ...
    static readonly SPLIT_BRAIN_PROTECTION: number;
    ...
    static readonly SESSION_EXPIRED_EXCEPTION: number;
    static readonly WAIT_KEY_CANCELLED_EXCEPTION: number;
    static readonly LOCK_ACQUIRE_LIMIT_REACHED_EXCEPTION: number;
    static readonly LOCK_OWNERSHIP_LOST_EXCEPTION: number;
    static readonly CP_GROUP_DESTROYED_EXCEPTION: number;
    static readonly CANNOT_REPLICATE_EXCEPTION: number;
    static readonly LEADER_DEMOTED_EXCEPTION: number;
    static readonly STALE_APPEND_REQUEST_EXCEPTION: number;
    static readonly NOT_LEADER_EXCEPTION: number;
    static readonly VERSION_MISMATCH_EXCEPTION: number;
}
