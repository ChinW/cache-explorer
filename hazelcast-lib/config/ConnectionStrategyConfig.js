 ...
 */
var ConnectionStrategyConfig = /** @class */ (function () {
    function ConnectionStrategyConfig() {
        /**
         ...
         */
        this.connectionRetryConfig = new ConnectionRetryConfig_1.ConnectionRetryConfig();
    }
    return ConnectionStrategyConfig;
}());
exports.ConnectionStrategyConfig = ConnectionStrategyConfig;
