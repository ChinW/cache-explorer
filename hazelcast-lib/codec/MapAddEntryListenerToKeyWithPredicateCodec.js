...
// hex: 0x011600
var REQUEST_MESSAGE_TYPE = 71168;
// hex: 0x011601
var RESPONSE_MESSAGE_TYPE = 71169;
// hex: 0x011602
var EVENT_ENTRY_MESSAGE_TYPE = 71170;
var REQUEST_INCLUDE_VALUE_OFFSET = ClientMessage_1.PARTITION_ID_OFFSET + BitsUtil_1.BitsUtil.INT_SIZE_IN_BYTES;
var REQUEST_LISTENER_FLAGS_OFFSET = REQUEST_INCLUDE_VALUE_OFFSET + BitsUtil_1.BitsUtil.BOOLEAN_SIZE_IN_BYTES;
...
var MapAddEntryListenerToKeyWithPredicateCodec = /** @class */ (function () {
    ...
    MapAddEntryListenerToKeyWithPredicateCodec.decodeResponse = function (clientMessage) {
    ...
    MapAddEntryListenerToKeyWithPredicateCodec.handle = function (clientMessage, handleEntryEvent) {
