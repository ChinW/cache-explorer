...
// hex: 0x010200
var REQUEST_MESSAGE_TYPE = 66048;
// hex: 0x010201
var RESPONSE_MESSAGE_TYPE = 66049;
...
var MapGetCodec = /** @class */ (function () {
    function MapGetCodec() {
    }
    MapGetCodec.encodeRequest = function (name, key, threadId) {
    ...
    MapGetCodec.decodeResponse = function (clientMessage) {
        // empty initial frame
