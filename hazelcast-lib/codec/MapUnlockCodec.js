...
// hex: 0x011300
var REQUEST_MESSAGE_TYPE = 70400;
// hex: 0x011301
var RESPONSE_MESSAGE_TYPE = 70401;
var REQUEST_THREAD_ID_OFFSET = ClientMessage_1.PARTITION_ID_OFFSET + BitsUtil_1.BitsUtil.INT_SIZE_IN_BYTES;
var REQUEST_REFERENCE_ID_OFFSET = REQUEST_THREAD_ID_OFFSET + BitsUtil_1.BitsUtil.LONG_SIZE_IN_BYTES;
var REQUEST_INITIAL_FRAME_SIZE = REQUEST_REFERENCE_ID_OFFSET + BitsUtil_1.BitsUtil.LONG_SIZE_IN_BYTES;
var MapUnlockCodec = /** @class */ (function () {
    function MapUnlockCodec() {
    }
    MapUnlockCodec.encodeRequest = function (name, key, threadId, referenceId) {
