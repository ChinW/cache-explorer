...
var DistributedObjectInfoCodec_1 = require("./custom/DistributedObjectInfoCodec");
// hex: 0x000800
var REQUEST_MESSAGE_TYPE = 2048;
// hex: 0x000801
var RESPONSE_MESSAGE_TYPE = 2049;
...
var ClientGetDistributedObjectsCodec = /** @class */ (function () {
    ...
    ClientGetDistributedObjectsCodec.decodeResponse = function (clientMessage) {
        // empty initial frame
        clientMessage.nextFrame();
        return {
            response: ListMultiFrameCodec_1.ListMultiFrameCodec.decode(clientMessage, DistributedObjectInfoCodec_1.DistributedObjectInfoCodec.decode),
        };
    };
