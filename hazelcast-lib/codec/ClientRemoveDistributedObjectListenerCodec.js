...
// hex: 0x000A00
var REQUEST_MESSAGE_TYPE = 2560;
// hex: 0x000A01
var RESPONSE_MESSAGE_TYPE = 2561;
var REQUEST_REGISTRATION_ID_OFFSET = ClientMessage_1.PARTITION_ID_OFFSET + BitsUtil_1.BitsUtil.INT_SIZE_IN_BYTES;
var REQUEST_INITIAL_FRAME_SIZE = REQUEST_REGISTRATION_ID_OFFSET + BitsUtil_1.BitsUtil.UUID_SIZE_IN_BYTES;
var RESPONSE_RESPONSE_OFFSET = ClientMessage_1.RESPONSE_BACKUP_ACKS_OFFSET + BitsUtil_1.BitsUtil.BYTE_SIZE_IN_BYTES;
var ClientRemoveDistributedObjectListenerCodec = /** @class */ (function () {
    function ClientRemoveDistributedObjectListenerCodec() {
    }
    ClientRemoveDistributedObjectListenerCodec.encodeRequest = function (registrationId) {
    ...
    ClientRemoveDistributedObjectListenerCodec.decodeResponse = function (clientMessage) {
    ...
    return ClientRemoveDistributedObjectListenerCodec;
}());
