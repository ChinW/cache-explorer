...
// hex: 0x030500
var REQUEST_MESSAGE_TYPE = 197888;
// hex: 0x030501
var RESPONSE_MESSAGE_TYPE = 197889;
var REQUEST_TIMEOUT_MILLIS_OFFSET = ClientMessage_1.PARTITION_ID_OFFSET + BitsUtil_1.BitsUtil.INT_SIZE_IN_BYTES;
var REQUEST_INITIAL_FRAME_SIZE = REQUEST_TIMEOUT_MILLIS_OFFSET + BitsUtil_1.BitsUtil.LONG_SIZE_IN_BYTES;
var QueuePollCodec = /** @class */ (function () {
    function QueuePollCodec() {
    }
    QueuePollCodec.encodeRequest = function (name, timeoutMillis) {
    ...
    QueuePollCodec.decodeResponse = function (clientMessage) {
        // empty initial frame
