...
// hex: 0x000100
var REQUEST_MESSAGE_TYPE = 256;
// hex: 0x000101
var RESPONSE_MESSAGE_TYPE = 257;
...
var ClientAuthenticationCodec = /** @class */ (function () {
    ...
    ClientAuthenticationCodec.encodeRequest = function (clusterName, username, password, uuid, clientType, serializationVersion, clientHazelcastVersion, clientName, labels) {
    ...
    ClientAuthenticationCodec.decodeResponse = function (clientMessage) {
