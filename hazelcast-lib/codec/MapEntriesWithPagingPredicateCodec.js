...
var PagingPredicateHolderCodec_1 = require("./custom/PagingPredicateHolderCodec");
var EntryListCodec_1 = require("./builtin/EntryListCodec");
var DataCodec_1 = require("./builtin/DataCodec");
var AnchorDataListHolderCodec_1 = require("./custom/AnchorDataListHolderCodec");
// hex: 0x013600
var REQUEST_MESSAGE_TYPE = 79360;
// hex: 0x013601
var RESPONSE_MESSAGE_TYPE = 79361;
var REQUEST_INITIAL_FRAME_SIZE = ClientMessage_1.PARTITION_ID_OFFSET + BitsUtil_1.BitsUtil.INT_SIZE_IN_BYTES;
var MapEntriesWithPagingPredicateCodec = /** @class */ (function () {
    function MapEntriesWithPagingPredicateCodec() {
    }
    MapEntriesWithPagingPredicateCodec.encodeRequest = function (name, predicate) {
    ...
    MapEntriesWithPagingPredicateCodec.decodeResponse = function (clientMessage) {
        // empty initial frame
        ...
        return {
            ...
            anchorDataList: AnchorDataListHolderCodec_1.AnchorDataListHolderCodec.decode(clientMessage),
        };
    };
