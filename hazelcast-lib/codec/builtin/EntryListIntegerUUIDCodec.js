...
var ENTRY_SIZE_IN_BYTES = BitsUtil_1.BitsUtil.INT_SIZE_IN_BYTES + BitsUtil_1.BitsUtil.UUID_SIZE_IN_BYTES;
var EntryListIntegerUUIDCodec = /** @class */ (function () {
    function EntryListIntegerUUIDCodec() {
    }
    EntryListIntegerUUIDCodec.encode = function (clientMessage, entries) {
    ...
    EntryListIntegerUUIDCodec.decode = function (clientMessage) {
        ...
        for (var i = 0; i < entryCount; i++) {
            ...
            var value = FixSizedTypesCodec_1.FixSizedTypesCodec.decodeUUID(frame.content, i * ENTRY_SIZE_IN_BYTES + BitsUtil_1.BitsUtil.INT_SIZE_IN_BYTES);
            result[i] = [key, value];
        }
        return result;
    };
    return EntryListIntegerUUIDCodec;
}());
