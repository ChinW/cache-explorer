...
var ListIntegerCodec = /** @class */ (function () {
    function ListIntegerCodec() {
    }
    ListIntegerCodec.encode = function (clientMessage, list) {
        var itemCount = list.length;
        var frame = new ClientMessage_1.Frame(Buffer.allocUnsafe(itemCount * BitsUtil_1.BitsUtil.INT_SIZE_IN_BYTES));
    ...
    ListIntegerCodec.decode = function (clientMessage) {
        var frame = clientMessage.nextFrame();
        var itemCount = frame.content.length / BitsUtil_1.BitsUtil.INT_SIZE_IN_BYTES;
