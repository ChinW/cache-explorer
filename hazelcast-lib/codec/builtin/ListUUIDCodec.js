...
var ListUUIDCodec = /** @class */ (function () {
    function ListUUIDCodec() {
    }
    ListUUIDCodec.encode = function (clientMessage, list) {
        var itemCount = list.length;
        var frame = new ClientMessage_1.Frame(Buffer.allocUnsafe(itemCount * BitsUtil_1.BitsUtil.UUID_SIZE_IN_BYTES));
    ...
    ListUUIDCodec.decode = function (clientMessage) {
        var frame = clientMessage.nextFrame();
        var itemCount = frame.content.length / BitsUtil_1.BitsUtil.UUID_SIZE_IN_BYTES;
