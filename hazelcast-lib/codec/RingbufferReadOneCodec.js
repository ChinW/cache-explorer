...
// hex: 0x170700
var REQUEST_MESSAGE_TYPE = 1509120;
// hex: 0x170701
var RESPONSE_MESSAGE_TYPE = 1509121;
var REQUEST_SEQUENCE_OFFSET = ClientMessage_1.PARTITION_ID_OFFSET + BitsUtil_1.BitsUtil.INT_SIZE_IN_BYTES;
var REQUEST_INITIAL_FRAME_SIZE = REQUEST_SEQUENCE_OFFSET + BitsUtil_1.BitsUtil.LONG_SIZE_IN_BYTES;
var RingbufferReadOneCodec = /** @class */ (function () {
    ...
    RingbufferReadOneCodec.decodeResponse = function (clientMessage) {
        // empty initial frame
